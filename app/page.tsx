...
export default function DDandJSportsVenture() {
  ...
  const allItems = [
    ...
    { cat: "Snooker & Billiards", name: "SNOOKER GLOVES", price: "₦3,000", images: ["/images/snooker-gloves.jpg"] },
    { cat: "Snooker & Billiards", name: "SNOOKER COIN DOLLAR/LIBERTY", price: "₦1,700" },
    { cat: "Snooker & Billiards", name: "CUE TIP GLUE", price: "₦700", images: ["/images/cue-tip-glue.jpg"] },
    ...
    { cat: "Apparel & Accessories", name: "NIKE GHOST LACE BOOT", price: "₦45,000" },
